---
title: "LK2025 Week X"
subtitle: "Conducting univariate descriptive analysis"
...
![Click this icon to run highlighted line of R Code](images/clipboard-3248158849.png){fig-align="left" width="56" height="20"}
...
-   There are two parts to the R code within the brackets, separated by a `,`:
    1.  `"../Data/csew.csv"` This is the name of the file (including file path information), and this is placed in quotes always.
